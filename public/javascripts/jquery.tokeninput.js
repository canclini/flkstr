...
$.TokenList = function (input, settings) {
    ...
    function init_list () {
        ...
        if(li_data && li_data.length) {
            for(var i in li_data) {
                ...
                $.data(this_token.get(0), "tokeninput", {"id": li_data[i].name, "name": li_data[i].name});
    ...
    function insert_token(id, value) {
      ...
      $.data(this_token.get(0), "tokeninput", {"id": value, "name": value});
    ...
    function add_token (item) {
        ...
        var this_token = insert_token(li_data.name, li_data.name);
